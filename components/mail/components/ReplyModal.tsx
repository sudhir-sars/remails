  ...
  return (
    <>
      <div
        className={`${
          !fullView ? ' hidden' : ''
        }  fixed inset-0 bg-[#ebecef]/50 backdrop-blur-xl  z-50 overflow-hidden flex justify-center `}
      >
        <span className={`flex space-x-4 mt-7 mb-10 h-[41rem]`}>
                  ...
                  <span className="flex justify-end items-center mr-2 my-2">
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent>
                        ...
                        <DropdownMenuItem
                          onClick={() => handleSchedule('60min')}
                        >
                          Send after 60 Min
                        </DropdownMenuItem>
                        <DropdownMenuItem
                          onClick={() => handleSchedule('1day')}
                        >
          ...
          <div className=" w-[17rem] max-h-[17rem]   space-y-10">
            <div className="max-h-[17rem] w-full   ">
              <AddPeople
                setToList={setToList}
                toList={toList}
