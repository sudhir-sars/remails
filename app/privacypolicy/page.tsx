...
export default function Component() {
  return (
    <div className="flex w-full h-screen items-center  justify-center ">
      <ScrollArea className="h-[500px] w-[70vw] rounded-md">
        <ScrollAreaViewport>
          <div className="container mx-auto px-4 py-8">
            ...
            <ul className="list-disc list-inside mb-4">
              <li className="mb-2">
                <p>
                  ...
                  unique account created for You to access our Service or parts
                  of our Service.
                </p>
              </li>
              <li className="mb-2">
              ...
              <li className="mb-2">
                <p>
                  <strong className="font-semibold">Company</strong> (referred
                  to as either &quot;the Company&quot, &quot;We&quot;,
              ...
              <li className="mb-2">
                <p>
                  <strong className="font-semibold">Personal Data</strong> is
              ...
              <li className="mb-2">
                <p>
                  <strong className="font-semibold">Usage Data</strong> refers
              ...
              <li className="mb-2">
                <p>
                  ...
                  remails, accessible from{' '}
                  <a
                    href="https://remails.vercel.app/"
                    rel="external nofollow noopener"
                    target="_blank"
                    className="text-blue-500 hover:underline"
                  >
                    https://remails.vercel.app/
                  </a>
                </p>
              </li>
              <li className="mb-2">
            ...
            <ul className="list-disc list-inside mb-4">
              ...
              <li className="mb-2">
                <strong className="font-semibold">With Affiliates:</strong> We
            ...
            <ul className="list-disc list-inside mb-4">
              <li>
                <a
                  href="https://remails-home.vercel.app/contact"
                  className="text-blue-500 hover:underline"
                >
