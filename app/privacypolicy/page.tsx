  ...
  return (
    <div className="flex w-full h-screen items-center  justify-center ">
      <ScrollArea className="h-[500px] w-[70vw] rounded-md">
        ...
        <p className="text-sm text-gray-600 mb-8">Last updated: August 29, 2024</p>
        ...
        <p className="mb-4">We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy. This Privacy Policy has been created with the help of the <a href="https://www.termsfeed.com/privacy-policy-generator/" target="_blank" className="text-blue-500 hover:underline">Privacy Policy Generator</a>.</p>
        ...
        <ul className="list-disc list-inside mb-4">
            <li className="mb-2">
                <p><strong className="font-semibold">Account</strong> means a unique account created for You to access our Service or parts of our Service.</p>
            </li>
            <li className="mb-2">
                <p><strong className="font-semibold">Affiliate</strong> means an entity that controls, is controlled by or is under common control with a party, where "control" means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.</p>
            </li>
            <li className="mb-2">
                <p><strong className="font-semibold">Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to remails.</p>
            </li>
            <li className="mb-2">
                <p><strong className="font-semibold">Cookies</strong> are small files that are placed on Your computer, mobile device or any other device by a website, containing the details of Your browsing history on that website among its many uses.</p>
            </li>
            <li className="mb-2">
                <p><strong className="font-semibold">Country</strong> refers to: Telangana, India</p>
            </li>
            <li className="mb-2">
                <p><strong className="font-semibold">Device</strong> means any device that can access the Service such as a computer, a cellphone or a digital tablet.</p>
            </li>
            <li className="mb-2">
                <p><strong className="font-semibold">Personal Data</strong> is any information that relates to an identified or identifiable individual.</p>
            </li>
            <li className="mb-2">
                <p><strong className="font-semibold">Service</strong> refers to the Website.</p>
            </li>
            <li className="mb-2">
            ...
            <li className="mb-2">
                <p><strong className="font-semibold">Third-party Social Media Service</strong> refers to any website or any social network website through which a User can log in or create an account to use the Service.</p>
            </li>
            <li className="mb-2">
                <p><strong className="font-semibold">Usage Data</strong> refers to data collected automatically, either generated by the use of the Service or from the Service infrastructure itself (for example, the duration of a page visit).</p>
            </li>
            <li className="mb-2">
                <p><strong className="font-semibold">Website</strong> refers to remails, accessible from <a href="https://remails.vercel.app/" rel="external nofollow noopener" target="_blank" className="text-blue-500 hover:underline">https://remails.vercel.app/</a></p>
            </li>
            <li className="mb-2">
                <p><strong className="font-semibold">You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</p>
            </li>
        </ul>
        ...
        <ul className="list-disc list-inside mb-4">
            ...
            <li className="mb-4">
                <strong className="font-semibold">Cookies Policy / Notice Acceptance Cookies</strong>
        ...
        <ul className="list-disc list-inside mb-4">
            <li className="mb-2">
                <strong className="font-semibold">To provide and maintain our Service</strong>, including to monitor the usage of our Service.
            </li>
            <li className="mb-2">
                <strong className="font-semibold">To manage Your Account:</strong> to manage Your registration as a user of the Service. The Personal Data You provide can give You access to different functionalities of the Service that are available to You as a registered user.
            </li>
            <li className="mb-2">
                <strong className="font-semibold">For the performance of a contract:</strong> the development, compliance and undertaking of the purchase contract for the products, items or services You have purchased or of any other contract with Us through the Service.
            </li>
            <li className="mb-2">
                <strong className="font-semibold">To contact You:</strong> To contact You by email, telephone calls, SMS, or other equivalent forms of electronic communication, such as a mobile application's push notifications regarding updates or informative communications related to the functionalities, products or contracted services, including the security updates, when necessary or reasonable for their implementation.
            </li>
            <li className="mb-2">
                <strong className="font-semibold">To provide You</strong> with news, special offers and general information about other goods, services and events which we offer that are similar to those that you have already purchased or enquired about unless You have opted not to receive such information.
            </li>
            <li className="mb-2">
                <strong className="font-semibold">To manage Your requests:</strong> To attend and manage Your requests to Us.
            </li>
            <li className="mb-2">
            ...
            <li className="mb-2">
                <strong className="font-semibold">For other purposes</strong>: We may use Your information for other purposes, such as data analysis, identifying usage trends, determining the effectiveness of our promotional campaigns and to evaluate and improve our Service, products, services, marketing and your experience.
            </li>
        </ul>
        <p className="mb-4">We may share Your personal information in the following situations:</p>
        <ul className="list-disc list-inside mb-4">
            <li className="mb-2"><strong className="font-semibold">With Service Providers:</strong> We may share Your personal information with Service Providers to monitor and analyze the use of our Service, to contact You.</li>
            <li className="mb-2"><strong className="font-semibold">For business transfers:</strong> We may share or transfer Your personal information in connection with, or during negotiations of, any merger, sale of Company assets, financing, or acquisition of all or a portion of Our business to another company.</li>
            <li className="mb-2"><strong className="font-semibold">With Affiliates:</strong> We may share Your information with Our affiliates, in which case we will require those affiliates to honor this Privacy Policy. Affiliates include Our parent company and any other subsidiaries, joint venture partners or other companies that We control or that are under common control with Us.</li>
            <li className="mb-2"><strong className="font-semibold">With business partners:</strong> We may share Your information with Our business partners to offer You certain products, services or promotions.</li>
            <li className="mb-2"><strong className="font-semibold">With other users:</strong> when You share personal information or otherwise interact in the public areas with other users, such information may be viewed by all users and may be publicly distributed outside. If You interact with other users or register through a Third-Party Social Media Service, Your contacts on the Third-Party Social Media Service may see Your name, profile, pictures and description of Your activity. Similarly, other users will be able to view descriptions of Your activity, communicate with You and view Your profile.</li>
            <li className="mb-2"><strong className="font-semibold">With Your consent</strong>: We may disclose Your personal information for any other purpose with Your consent.</li>
        </ul>
        
        <h3 className="text-xl font-semibold mt-6 mb-4">Retention of Your Personal Data</h3>
        ...
        <h3 className="text-xl font-semibold mt-6 mb-4">Transfer of Your Personal Data</h3>
        ...
        <h3 className="text-xl font-semibold mt-6 mb-4">Disclosure of Your Personal Data</h3>
        ...
        <h3 className="text-xl font-semibold mt-6 mb-4">Security of Your Personal Data</h3>
        ...
        <ul className="list-disc list-inside mb-4">
            <li><a href="https://remails-home.vercel.app/contact" className="text-blue-500 hover:underline">By visiting this page on our website</a></li>
        </ul>
        </div>
